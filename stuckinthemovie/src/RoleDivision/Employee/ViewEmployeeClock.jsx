        ...
        {Employees.map((Employee) => {
          if(Employee.status == "Active")
              return(
                          ...
                          <Link to="/EmployeeClock" state={{startTime: Employee.startTime, endTime: Employee.endTime}} >View Time</Link>
                          </td>
...
export default ViewEmployeeClock
